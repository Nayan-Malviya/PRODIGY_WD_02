...
const Card = ({ time, className }: { time: number; className?: string }) => {
  ...
  return (
    <div
      className={cn(
        "tabular-nums w-14 sm:w-24 md:w-36 text-center bg-background shadow-[rgba(23,43,_0,_0.2)_0px_60px_40px_-7px] text-foreground p-2 md:p-6 text-3xl sm:text-6xl md:text-9xl rounded-md font-teko",
        className
      )}
    >
      {formattedTime}
