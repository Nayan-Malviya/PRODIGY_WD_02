...
const StopwatchPage = () => {
  ...
  return (
    <main className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col gap-8 lg:flex-row lg:gap-16 lx:gap-32 font-teko p-4 md:p-12 lg:h-[473.6px]">
      <div className="flex flex-col gap-8 items-center justify-center md:p-8 md:py-12 p-4 rounded-lg shadow-[rgba(55,22,_0,_0.2)_0px_60px_40px_-7px] border border-muted">
